...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="<?php echo $_SESSION['home'] ?>admin" class="brand-logo" title="Inicio">
            <img src="<?php echo $_SESSION['public'] ?>img/logo.png" alt=" Logo Skates">
        </a>
        ...
        <?php if (isset($_SESSION['persona'])){ ?>
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                <?php if ($_SESSION['skates'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/skates" title="skates">Skates</a>
                    </li>
                <?php } ?>
...
<main>
    ...
    <header>
        ...
        <?php } else { ?>
            ...
            <h2>Bienvenido, introduce persona y contraseña.</h2>
