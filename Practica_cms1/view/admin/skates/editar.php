<h3>
    ...
    <a href="<?php echo $_SESSION['home'] ?>admin/skates" title="skates">Skates</a> <span>| </span>
    <?php if ($datos->id){ ?>
        <span>Editar <?php echo $datos->titulo ?></span>
    <?php } else { ?>
        <span>Nuevo Skate</span>
    <?php } ?>
</h3>
<div class="row">
    <?php $id = ($datos->id) ? $datos->id : "nuevo" ?>
    <form class="col s12" method="POST" enctype="multipart/form-data" action="<?php echo $_SESSION['home'] ?>admin/skates/editar/<?php echo $id ?>">
        <div class="col m12 l6">
            <div class="row">
                ...
                <div class="input-field col s12">
                    <input id="autor" type="text" name="autor" value="<?php echo $datos->precio ?>">
        ...
        <div class="row">
            <div class="input-field col s12">
                <a href="<?php echo $_SESSION['home'] ?>admin/skates" title="Volver">
