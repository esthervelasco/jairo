<h3>
    ...
    <a href="<?php echo $_SESSION['home'] ?>noticias" title="skates">Skates</a> <span>| </span>
        ...
        <div class="card horizontal large noticia">
            ...
            <div class="card-stacked">
                <div class="card-content">
                    ...
                    <br>
                    <p>
                        <strong>Fechaa</strong>: <?php echo date("d/m/Y", strtotime($datos->fecha)) ?><br>
                        <strong>Precio</strong>: <?php echo $datos->precio ?>
                    </p>
                </div>
            </div>
        </div>
