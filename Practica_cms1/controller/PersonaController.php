...
class PersonaController
{
    ...
    public function entrar(){
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            //Si existe el persona y lo hemos cambiado
            if ($persona->persona){
                //Compruebo la clave
                if (password_verify($campo_clave,$persona->clave)) {
                    ...
                    $_SESSION["skates"] = $persona->skates;
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $skates = (filter_input(INPUT_POST, 'skates', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("INSERT INTO personas (persona, clave, skates, personas) VALUES ('$persona','$clave_encriptada',$skates,$personas)");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE personas SET persona='$persona',clave='$clave_encriptada',skates=$skates,personas=$personas WHERE id='$id'") :
                    $this->db->exec("UPDATE personas SET persona='$persona',skates=$skates,personas=$personas WHERE id='$id'");
